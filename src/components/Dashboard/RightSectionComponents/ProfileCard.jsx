      ...
      {childlist.map((student,index) => (
        <Box>
          ...
          >
            ...
            <Box sx={{ flexGrow: 1, marginLeft: 2 }}>
              <Typography
                sx={{
                  fontWeight: 600,
                  color: selectedId === student.id ? "#ffffff" : "#000",
                }}
              >
                {student.full_name}
              </Typography>
              <Typography
                sx={{
                  fontSize: "14px",
                  color: selectedId === student.id ? "#ffffff" : "#555",
                }}
              >
          ...
          {/* <Box sx={{display:'flex',justifyContent:'space-between'}}>
            <Button variant="text">Cancel Subscription</Button>
            <Button variant="text">View Login Details</Button>
          </Box> */}
